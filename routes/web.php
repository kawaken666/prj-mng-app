...
Route::get('/dashboard', [DashboardController::class, 'index'])->middleware(['auth', 'verified'])->middleware('logging')->name('dashboard');

Route::middleware('auth')->middleware('logging')->group(function () {
